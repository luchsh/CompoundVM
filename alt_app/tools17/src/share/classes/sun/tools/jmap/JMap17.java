...
/*
 * This class is the main class for the JMap utility of JDK17. It parses its arguments
...
public class JMap17 {
    ...
    private static void executeCommandForPid(String pid, String command, Object ... args)
        ...
        try (InputStream in = getCommandOutput(hvm, command, args)) {
    ...
    private static InputStream getCommandOutput(HotSpotVirtualMachine vm, String command, Object ... args) throws IOException {
        switch(command) {
          case "jcmd":
            return vm.executeJCmd((String) args[0]);
          case "inspectheap":
    ...
    private static String parseFileName(String opt) {
        ...
        if (opt.length() > 5) {
            ...
            try {
                ...
                // directory where jmap17 is executed.
    ...
    private static void SAOptionError(String msg) {
        ...
        System.err.println("Cannot connect to core dump or remote debug server. Use jhsdb17 jmap instead");
        System.exit(1);
    }
    ...
    private static void usage(int exit) {
        ...
        System.err.println("");
        System.err.println("    Example: jmap17 -dump:live,format=b,file=heap.bin <pid>");
        System.err.println("");
        ...
        System.err.println("");
        System.err.println("    Example: jmap17 -histo:live,file=/tmp/histo.data <pid>");
        System.exit(exit);
    }
