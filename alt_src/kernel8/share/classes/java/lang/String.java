...
public final class String
    ...
    */
    ...
    public void getChars(int srcBegin, int srcEnd, char dst[], int dstBegin) {
        getChars(value, srcBegin, srcEnd, dst, dstBegin);
    }
    ...
    public int indexOf(int ch, int fromIndex) {
        ...
        if (ch < Character.MIN_SUPPLEMENTARY_CODE_POINT) {
            ...
            return indexOfChar(this.value, ch, fromIndex, max);
        } else {
    ...
    public int indexOf(String str) {
        return indexOf(value, str.value);
    }
    ...
    // extra fields used in jvm-17
    private final byte coder = 1; // default to UTF-16
    private boolean hashIsZero = false;
    static final boolean COMPACT_STRINGS = false;

    private static int indexOf(char[] value, char[] str) {
        return indexOf(value, 0, value.length, str, 0, str.length, 0);
    }

    private static int indexOf(char[] value, int valueCount, char[] str, int strCount, int fromIndex) {
        return indexOf(value, 0, valueCount, str, 0, strCount, fromIndex);
    }

    private static int indexOfChar(char[] value, int ch, int fromIndex, int max) {
        for (int i = fromIndex; i < max; i++) {
            if (value[i] == ch) {
                return i;
            }
